...
from Proyecto1.view import estadisticas_generales, regiones, XV_Arica, DataProduct1_19_74 ,DataProduct7, DataProduct4, DataProduct5, I_Tarapacá, II_Antofagasta, III_Atacama, IV_Coquimbo, V_Valparaiso, RM_Metropolitana, VI_OHiggins, VII_Maule, XVI_Nuble, VIII_Biobio, IX_Araucania, XIV_LosRios, X_LosLagos, XI_Aysen, XII_Magallanes
...
urlpatterns = [
    ...
    #JSON
    path('DP1-74.json', DataProduct1_19_74),
